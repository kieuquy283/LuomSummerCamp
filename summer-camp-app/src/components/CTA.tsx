  ...
  return (
    <section className="py-24 bg-brand-navy relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        {/* HeartHandshake Icon Decoration */}
        ...
        <div className="flex flex-col sm:flex-row justify-center items-center gap-6">
          <a href="#ung-tuyen" className="w-full sm:w-auto px-10 py-4 bg-brand-yellow hover:bg-brand-yellow-hover text-brand-navy font-bold rounded-full shadow-[0_0_20px_rgba(251,191,36,0.4)] transition-all hover:-translate-y-1 text-lg flex justify-center items-center gap-2 group">
            Ứng tuyển ngay
