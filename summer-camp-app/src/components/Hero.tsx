        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            <div className="inline-flex items-center px-4 py-2 rounded-full bg-brand-electric/10 border border-brand-electric/30 text-brand-cyan mb-6 text-sm font-medium">
              ...
              Tuyển sinh Trại hè 2024
            </div>
            
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-white leading-tight mb-6">
              Trại hè AI & <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-cyan to-brand-electric">An toàn thông tin</span> trong AI dành cho học sinh THCS
            </h1>
            
            <p className="text-lg md:text-xl text-slate-300 mb-8 max-w-2xl mx-auto lg:mx-0 leading-relaxed">
              Chương trình giúp học sinh cấp 2 khám phá Trí tuệ nhân tạo, biết cách sử dụng AI thông minh trong học tập và hình thành kỹ năng an toàn thông tin trong môi trường số.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start space-y-4 sm:space-y-0 sm:space-x-4 mb-12">
              <button className="w-full sm:w-auto px-8 py-3.5 bg-brand-yellow hover:bg-brand-yellow-hover text-brand-navy font-bold rounded-full shadow-[0_0_20px_rgba(251,191,36,0.4)] transition-all hover:-translate-y-1">
                Đăng ký tham gia
              </button>
              <button className="w-full sm:w-auto px-8 py-3.5 bg-transparent hover:bg-white/5 border border-slate-500 hover:border-white text-white font-medium rounded-full transition-all flex items-center justify-center group">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
              <div className="bg-white/5 border border-white/10 rounded-2xl p-4 backdrop-blur-sm flex flex-col items-center lg:items-start text-center lg:text-left hover:bg-white/10 transition-colors">
                ...
                <span className="text-sm text-white font-semibold mt-1">Trường TH Tô Hiệu</span>
              </div>
              <div className="bg-white/5 border border-white/10 rounded-2xl p-4 backdrop-blur-sm flex flex-col items-center lg:items-start text-center lg:text-left hover:bg-white/10 transition-colors">
              ...
              <div className="bg-white/5 border border-white/10 rounded-2xl p-4 backdrop-blur-sm flex flex-col items-center lg:items-start text-center lg:text-left hover:bg-white/10 transition-colors">
                ...
                <span className="text-xs text-slate-400 font-medium">Khai giảng</span>
                <span className="text-sm text-white font-semibold mt-1">Giữa tháng 6</span>
              </div>
              <div className="bg-white/5 border border-white/10 rounded-2xl p-4 backdrop-blur-sm flex flex-col items-center lg:items-start text-center lg:text-left hover:bg-white/10 transition-colors">
                <Users className="w-6 h-6 text-green-400 mb-2" />
                <span className="text-xs text-slate-400 font-medium">Quy mô</span>
                <span className="text-sm text-white font-semibold mt-1">20–25 HS/lớp</span>
              </div>
            </div>
          </div>
          ...
          <div className="relative h-[500px] w-full hidden lg:block">
            ...
            <div className="absolute top-[15%] left-[10%] bg-brand-navy/80 backdrop-blur-md border border-brand-cyan/50 p-6 rounded-2xl shadow-[0_0_30px_rgba(6,182,212,0.3)] transform -rotate-6 hover:rotate-0 transition-transform duration-500 z-20">
              <div className="flex flex-col items-center justify-center gap-3">
                ...
                <div className="text-center">
                  <p className="text-white font-bold">AI Core</p>
                  <p className="text-brand-cyan text-xs">Processing...</p>
                </div>
              </div>
            </div>
            ...
            <div className="absolute bottom-[20%] right-[5%] bg-brand-navy/80 backdrop-blur-md border border-brand-electric/50 p-6 rounded-2xl shadow-[0_0_30px_rgba(59,130,246,0.3)] transform rotate-6 hover:rotate-0 transition-transform duration-500 z-20">
              <div className="flex flex-col items-center justify-center gap-3">
                ...
                <div className="text-center">
                  <p className="text-white font-bold">Safe Data</p>
                  <p className="text-brand-electric text-xs">Protected</p>
                </div>
              </div>
            </div>
            ...
            <div className="absolute top-[30%] right-[15%] bg-brand-navy/90 backdrop-blur-sm border border-brand-yellow/30 p-4 rounded-tl-2xl rounded-tr-2xl rounded-bl-2xl shadow-xl transform translate-x-4 -translate-y-4 z-20 animate-bounce" style={{animationDuration: '3s'}}>
              <div className="flex items-center gap-3">
                ...
                <p className="text-sm text-white font-medium">Hello, I'm your AI tutor!</p>
              </div>
            </div>
